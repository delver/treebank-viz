...
(def tags {
  ...
  'DTV "marks the dative object in the unshifted form of the double object construction. If the preposition introducing the \"dative\" object is for, it is considered benefactive (-BNF). -DTV (and -BNF) is only used after verbs that can undergo dative shift."
  'LGS "is used to mark the logical subject in passives. It attaches to the NP object of by and not to the PP node itself."
  'PRD "marks any predicate that is not VP. In the do so construction, the so is annotated as a predicate."
  'PUT "marks the locative complement of put. "
  'SBJ "(subject) the structural surface subject of both matrix and embedded clauses, including those with null subjects."
